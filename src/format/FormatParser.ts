...
export default class FormatParser extends Parser {
	...
	public section(): SectionContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & 518826) !== 0)) {
				{
				{
				this.state = 8;
				this.para();
	...
	public sent(): SentContext {
		...
		try {
			...
			case 1:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				while ((((_la) & ~0x1F) === 0 && ((1 << _la) & 387754) !== 0)) {
					{
					{
					this.state = 26;
					this.sent();
	...
	public static readonly _serializedATN: number[] = [4,1,18,88,2,0,7,0,2,
	...
	8,2,10,2,12,2,63,9,2,1,2,1,2,1,2,5,2,68,8,2,10,2,12,2,71,9,2,1,2,1,2,3,
	2,75,8,2,1,3,3,3,78,8,3,1,3,4,3,81,8,3,11,3,12,3,82,1,3,3,3,86,8,3,1,3,
	0,0,4,0,2,4,6,0,1,1,0,13,16,102,0,11,1,0,0,0,2,23,1,0,0,0,4,74,1,0,0,0,
	6,85,1,0,0,0,8,10,3,2,1,0,9,8,1,0,0,0,10,13,1,0,0,0,11,9,1,0,0,0,11,12,
	1,0,0,0,12,1,1,0,0,0,13,11,1,0,0,0,14,16,3,4,2,0,15,14,1,0,0,0,16,17,1,
	0,0,0,17,15,1,0,0,0,17,18,1,0,0,0,18,20,1,0,0,0,19,21,5,17,0,0,20,19,1,
	0,0,0,20,21,1,0,0,0,21,24,1,0,0,0,22,24,5,17,0,0,23,15,1,0,0,0,23,22,1,
	0,0,0,24,3,1,0,0,0,25,29,5,1,0,0,26,28,3,4,2,0,27,26,1,0,0,0,28,31,1,0,
	0,0,29,27,1,0,0,0,29,30,1,0,0,0,30,32,1,0,0,0,31,29,1,0,0,0,32,75,5,2,0,
	0,33,37,5,3,0,0,34,36,3,4,2,0,35,34,1,0,0,0,36,39,1,0,0,0,37,35,1,0,0,0,
	37,38,1,0,0,0,38,40,1,0,0,0,39,37,1,0,0,0,40,75,5,4,0,0,41,45,5,5,0,0,42,
	44,3,4,2,0,43,42,1,0,0,0,44,47,1,0,0,0,45,43,1,0,0,0,45,46,1,0,0,0,46,48,
	1,0,0,0,47,45,1,0,0,0,48,75,5,6,0,0,49,53,5,7,0,0,50,52,3,4,2,0,51,50,1,
	0,0,0,52,55,1,0,0,0,53,51,1,0,0,0,53,54,1,0,0,0,54,56,1,0,0,0,55,53,1,0,
	0,0,56,75,5,8,0,0,57,61,5,9,0,0,58,60,3,4,2,0,59,58,1,0,0,0,60,63,1,0,0,
	0,61,59,1,0,0,0,61,62,1,0,0,0,62,64,1,0,0,0,63,61,1,0,0,0,64,75,5,10,0,
	0,65,69,5,11,0,0,66,68,3,4,2,0,67,66,1,0,0,0,68,71,1,0,0,0,69,67,1,0,0,
	0,69,70,1,0,0,0,70,72,1,0,0,0,71,69,1,0,0,0,72,75,5,12,0,0,73,75,3,6,3,
	0,74,25,1,0,0,0,74,33,1,0,0,0,74,41,1,0,0,0,74,49,1,0,0,0,74,57,1,0,0,0,
	74,65,1,0,0,0,74,73,1,0,0,0,75,5,1,0,0,0,76,78,5,18,0,0,77,76,1,0,0,0,77,
	78,1,0,0,0,78,80,1,0,0,0,79,81,7,0,0,0,80,79,1,0,0,0,81,82,1,0,0,0,82,80,
	1,0,0,0,82,83,1,0,0,0,83,86,1,0,0,0,84,86,5,18,0,0,85,77,1,0,0,0,85,84,
	1,0,0,0,86,7,1,0,0,0,14,11,17,20,23,29,37,45,53,61,69,74,77,82,85];
